...
class TypedRef:
    ...
    def __post_init__(self):
        ...
        object.__setattr__(self, "entity_type", self.entity_type.strip().lower())
        ...
        if any(not segment for segment in (self.domain, self.entity_type, self.provider)):
            raise ValueError("typed_ref segments must be non-empty")
