...
from agent_state_gate.config import AppConfig
...
def initialize_adapters(config: AppConfig | dict) -> AdapterRegistry:
    """
    ...
    if isinstance(config, AppConfig):
        adapters_config = config.adapters.model_dump(mode="python")
    else:
